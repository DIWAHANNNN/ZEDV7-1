...
return client.reply(msg,functions.util.format(evaluate), {quoted : msg, contextInfo: { externalAdReply: { title: botinfo.botname, "body": 'Multipurpose Whatsapp bot using baileys library!', thumbnailUrl:botinfo.thumb, sourceUrl: 'http://wa.me/94771323434'}}});
} catch(e){
return res.client.reply(msg,functions.util.format(e), {quoted : msg, contextInfo: { externalAdReply: { title: botinfo.botname, "body": 'Multipurpose Whatsapp bot using baileys library!', thumbnailUrl:botinfo.thumb, sourceUrl: 'http://wa.me/94771323434'}}});
}
...
if (err) return client.reply(msg,functions.util.format(err), {quoted : msg, contextInfo: { externalAdReply: { title: botinfo.botname, "body": 'Multipurpose Whatsapp bot using baileys library!', thumbnailUrl:botinfo.thumb, sourceUrl: 'http://wa.me/94771323434'}}});
client.reply(msg,functions.util.format(out), {quoted : msg, contextInfo: { externalAdReply: { title: botinfo.botname, "body": 'Multipurpose Whatsapp bot using baileys library!', thumbnailUrl:botinfo.thumb, sourceUrl: 'http://wa.me/94771323434'}}});
});
} catch(e){
 return res.client.reply(msg,functions.util.format(e), {quoted : msg, contextInfo: { externalAdReply: { title: botinfo.botname, "body": 'Multipurpose Whatsapp bot using baileys library!', thumbnailUrl:botinfo.thumb, sourceUrl: 'http://wa.me/94771323434'}}});
}
