...
cmd.on('yt','vid',['ytmp3','ytmp4','video'],['downloader'],async(msg,{client,query,prefix,isUrl,command}) => {
...
cmd.on('song','yt','play',['song','playvid','playaud'],['downloader'],async(msg,{query,client,prefix}) => {
