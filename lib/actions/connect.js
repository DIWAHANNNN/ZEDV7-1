...
functions.animate.succeed('Connecting',{text: 'Connect successful '+client.user.name});
zedsess.session = client.base64EncodedAuthInfo();
functions.fs.writeFileSync('./imash/zedsess.json',JSON.stringify(botinfo,null,2));
});
